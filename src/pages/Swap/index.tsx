import { CurrencyAmount, JSBI, Token, Trade } from '@carticfinance-libs/sdk'
import React, { useCallback, useContext, useEffect, useMemo, useState } from 'react'
import { ArrowDown } from 'react-feather'
import { CardBody, ArrowDownIcon, Button, IconButton, Text } from '@carticfinance-libs/uikit'
      ...
      <AppBody bg="primary">
                ...
                <ArrowWrapper clickable>
                  <IconButton
                    ...
                    style={{
                      ...
                      color: '#191326',
                      border: '2px solid #191326',
                    }}
                    scale="sm"
                  >
                    <ArrowDownIcon color="contrast" width="24px" />
                  </IconButton>
                </ArrowWrapper>
        ...
        <BottomGrouping>
          {!account ? (
            ...
            <Button variant="tertiary" disabled={Boolean(wrapInputError)} onClick={onWrap} width="100%">
