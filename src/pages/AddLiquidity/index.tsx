...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@carticfinance-libs/sdk'
import { Button, Card, CardBody, AddIcon, Text as UIKitText } from '@carticfinance-libs/uikit'
      ...
      <AppBody>
        ...
        >
          ...
          >
            ...
            >
              {noLiquidity && (
                <ColumnCenter style={{ marginBottom: 8 }}>
                  <Pane>
                    <AutoColumn gap="12px">
            ...
            <CardBody>
              <AutoColumn gap="20px">
                <ColumnCenter>
                  <AddIcon color="invertedContrast" />
                </ColumnCenter>
                <CurrencyInputPanel
          ...
          <AutoColumn style={{ padding: 16 }}>
            {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
              <div>
                ...
                <Card style={{ background: '#28C8F9', margin: '8px 0' }}>
                  <PoolPriceBar
                    currencies={currencies}
                    poolTokenPercentage={poolTokenPercentage}
                    noLiquidity={noLiquidity}
        ...
        <BottomGrouping>
          {!account ? (
            <ConnectWalletButton variant="tertiary" width="100%" />
          ) : (
            <AutoColumn gap="md">
