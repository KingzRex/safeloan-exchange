...
import { JSBI, Pair, Percent } from '@carticfinance-libs/sdk'
import { Button, Card as UIKitCard, CardBody, Text } from '@carticfinance-libs/uikit'
        ...
        <UIKitCard>
          <CardBody>
            <AutoColumn gap="12px">
              <FixedHeightRow>
                <RowFixed>
                  <Text style={{ textTransform: 'uppercase', fontWeight: 600 }} fontSize="12px" color="white">
